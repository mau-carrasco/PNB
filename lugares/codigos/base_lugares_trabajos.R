################################################
#### BBDD de lugares de trabajo en terreno ####
################################################
...
lugares_trabajos <- read_excel("GitHub/PNB/lugares/datos/lugares_trabajos.xlsx") %>%
  select(nombre_lugar, tipo_lugar, lat, long, tipo_ubicacion)

#### Obtención de información adicional de los lugares ####

lugares_trabajos <- lugares_trabajos %>%
...
lugares_trabajos <- lugares_trabajos %>% select(nombre_lugar, lat, long, direccion = address_found, tipo_ubicacion)

# Unión de los vectores

lugares_trabajos <- cbind(regiones, provincias, comunas, lugares_trabajos)
...
lugares_trabajos$tipo_ubicacion <- factor(lugares_trabajos$tipo_ubicacion)
lugares_trabajos$tipo_lugar <- factor(lugares_trabajos$tipo_lugar)

# etiquetas

var_label(lugares_trabajos) <- list(
...
openxlsx::write.xlsx(lugares_trabajos, "~/GitHub/PNB/lugares/resultados/lugares_trabajos.xlsx")
write_rds(lugares_trabajos, "~/GitHub/PNB/lugares/resultados/lugares_trabajos.rds")
